...
System.out.println("carriers"+carriers+"size"+carriers.size());
System.out.println("services"+services+"size"+services.size());
		if (carriers != null) {
...
System.out.println("this.rates.size()"+this.rates.size()+"this.rates"+this.rates);
		for(int i=0; i < this.rates.size(); i++) {
			...
			if (carriers != null && carriers.size() > 0 && !carriers.contains(this.rates.get(i).carrier.toLowerCase()) && !carriers.contains(this.rates.get(i).serviceCode.toLowerCase())) {
				System.out.println("carrierschekicng "+i);
			...
			if (services != null && services.size() > 0 && !services.contains(this.rates.get(i).service.toLowerCase()) && !services.contains(this.rates.get(i).serviceCode.toLowerCase())) {
				System.out.println("services chekicng "+i);
				lowestRate = this.rates.get(i);
				continue;
			}
			System.out.println("this.rates.get(i).rate"+this.rates.get(i).rate);
			if (lowestRate == null || lowestRate.rate > this.rates.get(i).rate) {
				System.out.println("lowestRate.rate chekicng dhnaa");
				lowestRate = this.rates.get(i);
				System.out.println("lowestRate"+lowestRate+"this.rates.get(i)"+this.rates.get(i));
			}
		}
